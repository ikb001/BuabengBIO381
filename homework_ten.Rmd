...
#looks like our data may not be large enough for the chosen types of visualizations. I am going to use a regular boxplot and a violin plot. My violin plots look terrible probabily due to the distribution of our data. I wonder what would happen if I normalized it. But for the purpose of this homework, I will be keeping it so until i receive feedback.
```
